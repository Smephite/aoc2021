...
for ins in instructions:
    ...
    if out_of_bounds(x) or out_of_bounds(y) or out_of_bounds(z):
        continue

    x = (bound_number(x[0]), bound_number(x[1]))
    y = (bound_number(y[0]), bound_number(y[1]))
    z = (bound_number(z[0]), bound_number(z[1]))
